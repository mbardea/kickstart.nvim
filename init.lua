...
-- List all buffers, except current, sorted by MRU
vim.keymap.set('n', '<leader><space>', function()
  require('telescope.builtin').buffers(
    { sort_mru = true, ignore_current_buffer = true }
  )
end, { desc = '[ ] Find existing buffers (sorted by MRU)' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'help', 'vim', 'elixir', 'heex', 'yaml' },
